...
export const metadata: Metadata = {
  title: "Security & Privacy | Is Everyone Safe",
  description:
    "Built and managed in the UK, hosted in the EU, fully GDPR compliant. Learn about our security measures and privacy commitments.",
  openGraph: {
    title: "Security & Privacy | Is Everyone Safe",
    description: "UK built, EU hosted, GDPR compliant crisis communication",
    url: "https://iseveryonesafe.com/security",
  },
}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Built and managed in UK, hosted in EU data centres
                      </p>
                    </div>
                  </div>
                </Card>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                We&apos;re happy to discuss our security measures and privacy commitments in detail.
              </p>
